...
- MT5 broker-server timestamps are normalized with the server UTC offset before storage, while the MT5 inbox displays the broker-server clock shown in MT5 to avoid browser timezone drift.
